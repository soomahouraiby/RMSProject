            ...
            <div class="btn-toolbar ">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right bg-light">
                        <a class="dropdown-item " href="{{route('OP_newReports')}}">جميع البلاغات</a>
                        <a class="dropdown-item " href="{{route('OP_newSmuggledReports')}}">مهرب</a>
                        <a class="dropdown-item " href="{{route('OP_newDrownReports')}}">مسحوب</a>
                        <a class="dropdown-item " href="{{route('OP_newDiffrentReports')}}">غير مطابق</a>
                        <a class="dropdown-item " href="{{route('OP_newExceptionReports')}}">مستثناء</a>
                    </div>
                </div>
            </div>
        </div>
